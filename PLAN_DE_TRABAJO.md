...
*   **Optimización Firestore — Fase 3 deploy + Win 1 (26 may, tarde — Antigravity)** — Deploy exitoso en producción:
    ...
    *   ⏳ **Limpieza Hosting Storage**: requiere acción manual en consola Firebase (Hosting → Release history → tres puntos → Release storage settings → mantener últimas 10–15 versiones). Firebase purga el excedente en 24 h.
...
- [ ] **Limpieza Hosting Storage 17.6 GB → 10 GB** (acción manual Daniel): Firebase Console → Hosting → Release history → tres puntos → Release storage settings → mantener últimas 10–15 versiones. Firebase purga el excedente en 24 h.

...
export const MobileBottomNav = {
    ...
    _injectMoreSheet(container, showReception) {
        ...
        if (AuthManager.canOpenAbsenceModal()) {
            items.unshift({
                id: 'mobileMoreAbsence',
                label: 'Vacaciones / Ausencia',
        ...
        sheet.addEventListener('click', async (e) => {
            ...
            switch (btn.id) {
                ...
                case 'mobileMoreSettings':
                    ...
                    break;
                case 'mobileMoreAbsence':
                    MobileNav.closeMoreSheet();
                    (await import('../modules/calendar/AbsenceModal.js')).AbsenceModal.open();
                    break;
                case 'mobileMoreReception':
                    MobileNav.openReception();
                    break;
                case 'mobileMoreAudit':
                    MobileNav.closeMoreSheet();
                    (await import('../modules/admin/AuditPanel.js')).AuditPanel.open();
                    break;
                case 'mobileMoreHelp': {

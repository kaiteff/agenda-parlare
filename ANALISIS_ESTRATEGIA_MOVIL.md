...
> **Última sesión de implementación:** **21 May 2026** — Lógica de excepción de Opt-In para pacientes antiguos, inicialización en `on_patient_created` y flujo manual de Bienvenida (`wantsWhatsapp = false`, `recurrentOptIn = 'pending'`), integración con webhook para reactivación automática de consentimientos, y soporte completo para estados detallados de WhatsApp en la Bitácora.
>
> **Sesión previa (19 may):** Hotfix calendario móvil, Bitácora en menú Más, actualización de docs y manual. Ver `resumen_sesion/RESUMEN_SESION_20260519.md`.
...
*Última actualización de este documento: **21 de Mayo de 2026** (cierre sesión — consentimientos WhatsApp + bitácora auditoría).*

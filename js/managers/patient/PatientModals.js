            ...
            dom.patientHistoryTitle.innerHTML = `
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <div class="flex items-center gap-2">
                        <button id="patientWelcomeBtn" class="flex items-center gap-1.5 px-2.5 py-1.5 bg-green-100 text-green-700 text-[10px] font-bold uppercase rounded-lg border border-green-200 hover:bg-green-200 transition-colors" title="Enviar Mensaje de Bienvenida">
